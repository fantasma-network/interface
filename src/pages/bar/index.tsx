  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.fantasma.network/stake" />
        ...
        <meta
          ...
          content="Stake SUSHI in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all SUSHI products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.fantasma.network/images/xsushi-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE SUSHI" />
        <meta key="og:url" property="og:url" content="https://app.fantasma.network/stake" />
        <meta key="og:image" property="og:image" content="https://app.fantasma.network/images/xsushi-sign.png" />
        <meta
          key="og:description"
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          ...
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image
              src="https://app.fantasma.network/images/xsushi-sign.png"
              alt="xSUSHI sign"
              width="100%"
              height="100%"
              layout="responsive"
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between w-full h-24 max-w-xl p-4 rounded md:pl-5 md:pr-7 bg-yellow bg-opacity-40">
                <div className="flex flex-col">
                  ...
                  <div className="flex">
                    <a
                      href={`https://analytics.fantasma.network/bar`}
                      target="_blank"
              ...
              <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    <Image
                      ...
                      src="https://app.fantasma.network/images/tokens/xsushi-square.jpg"
                      alt="xSUSHI"
                      width={64}
                      height={64}
                    />
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    <Image
                      className="max-w-10 md:max-w-16 -ml-1 mr-1 md:mr-2 -mb-1.5 rounded"
                      src="https://app.fantasma.network/images/tokens/sushi-square.jpg"
                      alt="SUSHI"
                      width={64}
                      height={64}
                    />
                ...
                <div className="flex flex-col w-full mb-4 mt-7 md:mb-0">
                  ...
                  {account && (
                    <a
                      href={`https://analytics.fantasma.network/users/${account}`}
                      target="_blank"
                      rel="noreferrer noopener"
                      className={`
