              ...
              <Image
                src={
                  currency === SUSHI[ChainId.ETHEREUM]
                    ? 'https://app.fantasma.network/images/tokens/sushi-square.jpg'
                    : currency === XSUSHI
                    ? 'https://app.fantasma.network/images/tokens/xsushi-square.jpg'
                    : 'https://app.fantasma.network/images/tokens/nyan-square.jpg'
                }
                alt="SUSHI"
                width="62px"
                height="62px"
