        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-center gap-4">
            <div className="relative shadow-pink-glow">
              <Image src="https://app.fantasma.network/images/bentobox/logo.png" width={160} height={120} alt="BentoBox Logo" />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <Typography variant="sm" className="text-center text-secondary">
                {i18n._(t`You can think of this as having "account balances" for each asset within fantasma.network`)}
              </Typography>
            </div>
          </div>
