...
export const ANALYTICS_URL: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.FUSE]: 'https://analytics-fuse.fantasma.network',
  [ChainId.MOONRIVER]: 'https://analytics-moonriver.fantasma.network',
  [ChainId.CELO]: 'https://analytics-celo.fantasma.network',
}
